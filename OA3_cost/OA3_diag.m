function [classifier, cost, sen, spe, acc, que, run_time, TMs, P,idx] = OA3_diag(Y, X, options, id_list)
% The diagnal version of OA3_cost: Online Adaptive Asymmetric Active Learning 
%---------------------------------------------------------
% Input:
