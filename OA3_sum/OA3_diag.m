function [classifier, summ, sen, spe, acc, que, run_time, TMs, P,idx] = OA3_diag(Y, X, options, id_list)
% The diagnoal version of OA3_sum: Adaptive Cost-sensitive Online Asymmetric Active Learning 
%---------------------------------------------------------
% Input:
